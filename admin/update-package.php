...
$sql="update TblTourPackages set PackageName=:pname, Duration=:pduration, PackageType=:ptype, GroupSize=:pgrpsize, TourGuide=:ptourguide, PackageLocation=:plocation,PackagePrice=:pprice,PackageFetures=:pfeatures,PackageDetails=:pdetails, Destination=:pdestination, DepatureTime=:pdepaturetime, ReturnTime=:preturntime, Included=:pincluded, Excluded=:pexcluded, TPDay1Tittle=:tpdayonetit, TPDay1Des=:tpdayonedes, TPDay2Tittle=:tpdaytwotit, TPDay2Des=:tpdaytwodes where PackageId=:pid";
